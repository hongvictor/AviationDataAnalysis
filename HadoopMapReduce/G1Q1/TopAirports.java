...
public class TopAirports extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Path tmpPath = new Path("/T1/G1Q1/tmp");
...
// <<< Don't Change
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        // xTODO
			...
			while (tokenizer.hasMoreTokens()) {
                ...
                String word = nextToken.trim().toLowerCase();
    ...
    public static class TopAirportsMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        Integer N;
        // xTODO
        public static final Log log = LogFactory.getLog(TopAirportsMap.class);
...
//            System.out.println("printout: TopAirportsMap: setup N=" + this.N); 
        }
