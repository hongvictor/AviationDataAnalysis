...
in  = LOAD '$PIG_IN_DIR' AS ( FlightDate:chararray, Carrier:chararray, FlightNumber:chararray,  Origin:chararray, Dest:chararray, CRSDepartureTime:chararray, ArrDel:int );
